...
async function startGame(){
    ...
    await generateBoard(game1, player, computer);
    ...
    console.log(computer.gameboard.shipsArray)

    computerShip.forEach(set => {
        let ship = new Ship(set.length,0,false);
        ship.cords = set
        computer.gameboard.shipsArray.push(ship);
        computer.gameboard.shipsArray.slice(1,4)       //<--Unkown ship index 0 being added
